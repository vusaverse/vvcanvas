...
This outlines how to propose a change to vvcanvas. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("vusaverse/vvcanvas", fork = TRUE)`.
...
Please note that the vvcanvas project is released with a [Contributor
Code of
Conduct](https://vusaverse.github.io/vvcanvas/CODE_OF_CONDUCT.md). By
